...
def test_configured_calendars_both(monkeypatch):
    ...
    assert [c[1] for c in cals] == ["Benno@atolls.com", "Bennoschwede@gmail.com"]
...
async def test_calendar_node_merges_both_calendars(monkeypatch):
    ...
    assert "[Benno@atolls.com]" in captured["prompt"] and "[Bennoschwede@gmail.com]" in captured["prompt"]
